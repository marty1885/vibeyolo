...
- [ ] **Attention integration shim — `/model.22` A2C2f** *(next up — parametric clone of `/model.10` shim)* — parametric clone of the `/model.10` shim. L88..L92 shapes are byte-identical to L34..L38 per ONNX. Trivial after the model.10 shim exists.
