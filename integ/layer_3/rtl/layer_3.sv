...
//
// layer_3 — YOLO26n /model.2/m.0/cv1 Conv-BN-SiLU (3x3, 16->8, stride 1, pad 1).
...
module layer_3
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_3_COUT,
  parameter int  CIN        = LAYER_3_CIN,
  parameter int  K          = LAYER_3_K,
  parameter int  STRIDE     = LAYER_3_STRIDE,
  parameter int  PAD        = LAYER_3_PAD,
  ...
  conv_layer #(
    ...
    .H_OUT(LAYER_3_H), .W_OUT(LAYER_3_W),
