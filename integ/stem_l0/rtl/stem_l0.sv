...
//
// stem_l0 — YOLO26n /model.0 Conv-BN-SiLU stem layer (3x3, stride 2, 3->16).
...
#(
  ...
  parameter int  P_CIN      = 3,
  parameter real S_OUT_PRE  = 64.0 / 127.0,
  parameter real S_OUT_SILU = 64.0 / 127.0
) (
  input  logic                                            clk_i,
  input  logic                                            rst_ni,
