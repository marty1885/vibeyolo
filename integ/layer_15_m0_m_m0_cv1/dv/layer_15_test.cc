...
//
// layer_15_test — 3x3, 32→32, stride 1, non-residual. Pattern from layer_11.
...
#include "Vlayer_15_tb.h"
#include "sim_ctrl.h"

using DUT = Vlayer_15_tb;
...
static constexpr double S_OUT_SILU = 2.136 / 127.0;
