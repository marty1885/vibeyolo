...
//
// layer_18_test — 3x3, 32→32, residual. Pattern from layer_11 + residual driver.
...
#include "Vlayer_18_tb.h"
#include "sim_ctrl.h"

using DUT = Vlayer_18_tb;
...
static constexpr double S_OUT_SILU = 5.795 / 127.0;
