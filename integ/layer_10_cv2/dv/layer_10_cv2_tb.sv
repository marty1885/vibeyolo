...
//
// layer_10_cv2_tb — Verilator wrapper around layer_10_cv2 (tiled).
//
// Geometry (scale_pkg_dv): P_COUT=64, P_CIN=8, K=1, CIN=96, COUT=128.
...
//   N_COUT_TILE = 2 (1 bit), N_CIN_TILE = 12

module layer_10_cv2_tb (
  input  logic                  clk_i,
  input  logic                  rst_ni,
