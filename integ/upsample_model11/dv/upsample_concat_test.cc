...
// Chain mode: stream external A (CHAIN_IN_A) + B (CHAIN_IN_B) int8 frames
// through the real upsample_concat IP, dump H_O*W_O*C_O int8 to CHAIN_OUT, so
// tools/e2e/chain.py can run the real upsample IP in the end-to-end chain.
