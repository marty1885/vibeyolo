...
//
// layer_20_tb — Verilator wrapper around layer_20.
// Geometry: COUT=128, CIN=192, K=1, P_COUT=64, P_CIN=4.
//   x_i  : K*K*P_CIN = 4 lanes  (32 bits)
//   w_i  : P_COUT * 4 = 64*4*8 = 2048 bits
