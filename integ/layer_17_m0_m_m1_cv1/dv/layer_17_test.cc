...
//
// layer_17_test — 3x3, 32→32, stride 1, non-residual. Pattern from layer_11.
...
#include "Vlayer_17_tb.h"
#include "sim_ctrl.h"

using DUT = Vlayer_17_tb;
...
static constexpr double S_OUT_SILU = 2.000 / 127.0;

// dotN latency = 1 + clog2(9) = 1 + 4 = 5
static constexpr int DOT_LAT     = 5;
...
// Window: K*K*P_CIN lanes; lane = (kh*K + kw)*P_CIN + kc_local
