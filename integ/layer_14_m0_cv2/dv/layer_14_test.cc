...
//
// layer_14_test — Integration test for the YOLO26n /model.6/m.0/cv2 layer
// (1×1, 64→32, non-residual). Per-tile streaming, pattern from layer_11.
...
#include "Vlayer_14_tb.h"
#include "sim_ctrl.h"

using DUT = Vlayer_14_tb;
...
static constexpr double S_OUT_SILU = 3.617 / 127.0;
