...
//
// layer_5 — YOLO26n /model.2/cv2 Conv-BN-SiLU (1x1, 48->64, stride 1, pad 0).

// verilator lint_off UNUSEDPARAM
module layer_5
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_5_COUT,
  parameter int  CIN        = LAYER_5_CIN,
  parameter int  K          = LAYER_5_K,
  parameter int  STRIDE     = LAYER_5_STRIDE,
  parameter int  PAD        = LAYER_5_PAD,
  ...
  conv_layer #(
    ...
    .H_OUT(LAYER_5_H), .W_OUT(LAYER_5_W),
