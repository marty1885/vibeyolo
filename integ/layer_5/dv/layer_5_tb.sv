...
//
// layer_5_tb — Verilator wrapper around tiled layer_5 (1x1, 48->64).
// P_COUT=16 -> N_COUT_TILE=4 (2-bit idx). P_CIN=8 -> N_CIN_TILE=6.
...
module layer_5_tb (
  ...
  input  logic        [63:0]  x_flat_i,           // 1*1*8 * 8 = 64
  input  logic       [1023:0] w_flat_i,           // 16*8*8 = 1024
