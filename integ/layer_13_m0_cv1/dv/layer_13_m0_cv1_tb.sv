...
//
// layer_13_m0_cv1_tb — Verilator wrapper around layer_13_m0_cv1. Flattens
// ports so the C++ test can drive 2-lane phases (2 bytes = 16 bits) and
// read 32-channel int8 outputs (256 bits) each cycle.

module layer_13_m0_cv1_tb (
  input  logic               clk_i,
  input  logic               rst_ni,

  input  logic               valid_i,
  input  logic         [4:0] phase_i,        // log2(32) = 5
  // 2 lanes × 8 bits = 16 bits
  input  logic        [15:0] x_flat_i,
  // 32 channels × 2 lanes × 8 bits = 512 bits
