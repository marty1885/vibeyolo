...
//
// layer_6_test — Integration test for tiled layer_6 (3x3 s2, 64->64).
...
#include "Vlayer_6_tb.h"
#include "sim_ctrl.h"

using DUT = Vlayer_6_tb;
...
static constexpr int N_CIN_TILE  = (NCH_IN  + P_CIN  - 1) / P_CIN;        // 8
static constexpr int N_LANE_TILE = K * K * P_CIN;                          // 72
static constexpr int N_LANE_FULL = K * K * NCH_IN;                         // 576
...
static constexpr double S_OUT_SILU = 8.0 / 127.0;
