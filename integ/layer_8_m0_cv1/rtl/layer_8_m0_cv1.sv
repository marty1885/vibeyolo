...
//
// layer_8_m0_cv1 — YOLO26n /model.4/m.0/cv1 Conv-BN-SiLU (3x3, 32->16, stride 1, pad 1).
//
// Thin shim over the reusable conv_layer IP.

// verilator lint_off UNUSEDPARAM
module layer_8_m0_cv1
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_8_COUT,    // 16
  parameter int  CIN        = LAYER_8_CIN,     // 32
  parameter int  K          = LAYER_8_K,       // 3
  parameter int  STRIDE     = LAYER_8_STRIDE,  // 1
  parameter int  PAD        = LAYER_8_PAD,     // 1
  parameter int  P_COUT     = LAYER_8_P_COUT,  // 16
  parameter int  P_CIN      = LAYER_8_P_CIN,   // 4
  ...
  conv_layer #(
    ...
    .STRIDE    (STRIDE),
    .PAD       (PAD),
    .H_OUT     (LAYER_8_H / STRIDE),
    .W_OUT     (LAYER_8_W / STRIDE),
    .P_COUT    (P_COUT),
    .P_CIN     (P_CIN),
    .RESIDUAL  (0),
    .SILU      (1),
