...
//
// layer_8_m0_cv1_tb — Verilator wrapper around layer_8_m0_cv1 (tiled).
//
// Geometry (scale_pkg_dv): P_COUT=16, P_CIN=4, K=3, CIN=32, COUT=16.
//   x_i  : K*K*P_CIN = 36   i8 lanes  (288 bits)
//   w_i  : P_COUT * 36 i8           (16 * 36 * 8 = 4608 bits)
//   scale_i / bias_i : P_COUT fp16  (256 bits each)
//   y_o  : P_COUT i8                (128 bits)
//   N_COUT_TILE = 1

module layer_8_m0_cv1_tb (
  input  logic                  clk_i,
  input  logic                  rst_ni,
  ...
  logic signed [35:0][7:0]                 x_w;
  logic signed [15:0][35:0][7:0]           w_w;
