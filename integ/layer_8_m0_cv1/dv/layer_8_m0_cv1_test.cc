...
//
// layer_8_m0_cv1_test — Integration test for tiled YOLO26n /model.4/m.0/cv1.
//
// Layer params (scale_pkg_dv):
//   COUT=16, CIN=32, K=3, P_COUT=16, P_CIN=4
...
#include "Vlayer_8_m0_cv1_tb.h"
#include "sim_ctrl.h"

using DUT = Vlayer_8_m0_cv1_tb;
...
static constexpr int N_LANE_TILE = K * K * P_CIN;           // 36
...
static constexpr int DOT_LAT     = 1 + 6;  // 1 + clog2(36)
