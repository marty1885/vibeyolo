...
//
// layer_2_test — Integration test for tiled layer_2 (1x1, 32->32).
// Mirrors integ/layer_1/dv/layer_1_test.cc but for K=1.
...
#include "Vlayer_2_tb.h"
#include "sim_ctrl.h"

using DUT = Vlayer_2_tb;
...
static constexpr int N_CIN_TILE  = (NCH_IN  + P_CIN  - 1) / P_CIN;        // 4
static constexpr int N_LANE_TILE = K * K * P_CIN;                          // 8
static constexpr int N_LANE_FULL = K * K * NCH_IN;                         // 32
...
static constexpr double S_OUT_SILU = 24.0 / 127.0;
