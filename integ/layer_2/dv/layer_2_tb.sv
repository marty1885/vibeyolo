...
//
// layer_2_tb — Verilator wrapper around tiled layer_2 (1x1, 32->32).
// P_COUT=16, P_CIN=8, K=1. N_COUT_TILE=2, N_CIN_TILE=4.
...
module layer_2_tb (
  ...
  input  logic        [63:0]  x_flat_i,           // 1*1*8 * 8 bits = 64
  input  logic       [1023:0] w_flat_i,           // 16*1*1*8 * 8 bits = 1024
