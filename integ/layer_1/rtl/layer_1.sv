...
//
// layer_1 — YOLO26n /model.1/conv Conv-BN-SiLU (3x3, stride 2, 16->32).
...
module layer_1
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_1_COUT,
  parameter int  CIN        = LAYER_1_CIN,
  parameter int  K          = LAYER_1_K,
  parameter int  STRIDE     = LAYER_1_STRIDE,
  parameter int  PAD        = LAYER_1_PAD,
