...
//
// Generated skeleton for L59: /model.23/one2one_cv2.0/one2one_cv2.0.0/conv/Conv_quant  (SILU=0)

module layer_59
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_59_COUT,
  parameter int  CIN        = LAYER_59_CIN,
  parameter int  K          = LAYER_59_K,
  parameter int  STRIDE     = LAYER_59_STRIDE,
  parameter int  PAD        = LAYER_59_PAD,
  parameter int  P_COUT     = LAYER_59_P_COUT,
  parameter int  P_CIN      = LAYER_59_P_CIN,
  parameter int  P_PIX      = LAYER_59_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_59_H), .W_OUT(LAYER_59_W),
