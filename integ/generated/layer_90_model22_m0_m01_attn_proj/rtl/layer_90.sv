...
//
// Generated skeleton for L90 (RESIDUAL=1): /model.22/m.0/m.0.1/attn/proj/conv/Conv_quant

module layer_90
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_90_COUT,
  parameter int  CIN        = LAYER_90_CIN,
  parameter int  K          = LAYER_90_K,
  parameter int  STRIDE     = LAYER_90_STRIDE,
  parameter int  PAD        = LAYER_90_PAD,
  parameter int  P_COUT     = LAYER_90_P_COUT,
  parameter int  P_CIN      = LAYER_90_P_CIN,
  parameter int  P_PIX      = LAYER_90_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_90_H), .W_OUT(LAYER_90_W),
