...
//
// Generated skeleton for L31: /model.9/cv1/conv/Conv_quant  (SILU=0)

module layer_31
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_31_COUT,
  parameter int  CIN        = LAYER_31_CIN,
  parameter int  K          = LAYER_31_K,
  parameter int  STRIDE     = LAYER_31_STRIDE,
  parameter int  PAD        = LAYER_31_PAD,
  parameter int  P_COUT     = LAYER_31_P_COUT,
  parameter int  P_CIN      = LAYER_31_P_CIN,
  parameter int  P_PIX      = LAYER_31_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_31_H), .W_OUT(LAYER_31_W),
