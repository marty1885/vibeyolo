...
//
// Generated skeleton for L29: /model.8/m.0/cv3/conv/Conv_quant  (SILU=1)

module layer_29
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_29_COUT,
  parameter int  CIN        = LAYER_29_CIN,
  parameter int  K          = LAYER_29_K,
  parameter int  STRIDE     = LAYER_29_STRIDE,
  parameter int  PAD        = LAYER_29_PAD,
  parameter int  P_COUT     = LAYER_29_P_COUT,
  parameter int  P_CIN      = LAYER_29_P_CIN,
  parameter int  P_PIX      = LAYER_29_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_29_H), .W_OUT(LAYER_29_W),
