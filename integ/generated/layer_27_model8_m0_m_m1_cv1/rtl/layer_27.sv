...
//
// Generated skeleton for L27: /model.8/m.0/m/m.1/cv1/conv/Conv_quant  (SILU=1)

module layer_27
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_27_COUT,
  parameter int  CIN        = LAYER_27_CIN,
  parameter int  K          = LAYER_27_K,
  parameter int  STRIDE     = LAYER_27_STRIDE,
  parameter int  PAD        = LAYER_27_PAD,
  parameter int  P_COUT     = LAYER_27_P_COUT,
  parameter int  P_CIN      = LAYER_27_P_CIN,
  parameter int  P_PIX      = LAYER_27_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_27_H), .W_OUT(LAYER_27_W),
