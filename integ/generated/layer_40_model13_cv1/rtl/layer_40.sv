...
//
// Generated skeleton for L40: /model.13/cv1/conv/Conv_quant  (SILU=1)

module layer_40
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_40_COUT,
  parameter int  CIN        = LAYER_40_CIN,
  parameter int  K          = LAYER_40_K,
  parameter int  STRIDE     = LAYER_40_STRIDE,
  parameter int  PAD        = LAYER_40_PAD,
  parameter int  P_COUT     = LAYER_40_P_COUT,
  parameter int  P_CIN      = LAYER_40_P_CIN,
  parameter int  P_PIX      = LAYER_40_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_40_H), .W_OUT(LAYER_40_W),
