# layer_40_model13_cv1

Generated ordinary Conv+SiLU integration layer for `/model.13/cv1/conv/Conv_quant`.

- Shape: Cin=384 Cout=128 K=1 stride=1 pad=0
- Output: 40x40
- Generated DV wrapper factors: P_PIX=2, P_COUT=16, P_CIN=8, cycles~307200
