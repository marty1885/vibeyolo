...
//
// Generated skeleton for L24: /model.8/m.0/cv2/conv/Conv_quant

module layer_24
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_24_COUT,
  parameter int  CIN        = LAYER_24_CIN,
  parameter int  K          = LAYER_24_K,
  parameter int  STRIDE     = LAYER_24_STRIDE,
  parameter int  PAD        = LAYER_24_PAD,
  parameter int  P_COUT     = LAYER_24_P_COUT,
  parameter int  P_CIN      = LAYER_24_P_CIN,
  parameter int  P_PIX      = LAYER_24_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_24_H), .W_OUT(LAYER_24_W),
