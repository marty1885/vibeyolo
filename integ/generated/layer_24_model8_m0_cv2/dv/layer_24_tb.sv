...
//
// Generated Verilator wrapper for L24. Widths assume generated DV caps.
...
module layer_24_tb (
  ...
  logic signed [0:0][3:0][7:0]     x_w;
  logic signed [15:0][3:0][7:0]    w_w;
  logic        [15:0][15:0]                 scale_w, bias_w;
  logic signed [0:0][15:0][7:0]     y_w;
  ...
  layer_24 #(.P_COUT(16), .P_CIN(4), .P_PIX(1)) u_dut (
