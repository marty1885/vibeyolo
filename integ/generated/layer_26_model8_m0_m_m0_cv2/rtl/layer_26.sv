...
//
// Generated skeleton for L26 (RESIDUAL=1): /model.8/m.0/m/m.0/cv2/conv/Conv_quant

module layer_26
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_26_COUT,
  parameter int  CIN        = LAYER_26_CIN,
  parameter int  K          = LAYER_26_K,
  parameter int  STRIDE     = LAYER_26_STRIDE,
  parameter int  PAD        = LAYER_26_PAD,
  parameter int  P_COUT     = LAYER_26_P_COUT,
  parameter int  P_CIN      = LAYER_26_P_CIN,
  parameter int  P_PIX      = LAYER_26_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_26_H), .W_OUT(LAYER_26_W),
