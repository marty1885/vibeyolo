...
//
// Generated skeleton for L86: /model.22/m.0/m.0.0/cv2/conv/Conv_quant  (SILU=0)

module layer_86
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_86_COUT,
  parameter int  CIN        = LAYER_86_CIN,
  parameter int  K          = LAYER_86_K,
  parameter int  STRIDE     = LAYER_86_STRIDE,
  parameter int  PAD        = LAYER_86_PAD,
  parameter int  P_COUT     = LAYER_86_P_COUT,
  parameter int  P_CIN      = LAYER_86_P_CIN,
  parameter int  P_PIX      = LAYER_86_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_86_H), .W_OUT(LAYER_86_W),
