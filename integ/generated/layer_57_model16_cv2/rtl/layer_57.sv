...
//
// Generated skeleton for L57: /model.16/cv2/conv/Conv_quant  (SILU=1)

module layer_57
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_57_COUT,
  parameter int  CIN        = LAYER_57_CIN,
  parameter int  K          = LAYER_57_K,
  parameter int  STRIDE     = LAYER_57_STRIDE,
  parameter int  PAD        = LAYER_57_PAD,
  parameter int  P_COUT     = LAYER_57_P_COUT,
  parameter int  P_CIN      = LAYER_57_P_CIN,
  parameter int  P_PIX      = LAYER_57_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_57_H), .W_OUT(LAYER_57_W),
