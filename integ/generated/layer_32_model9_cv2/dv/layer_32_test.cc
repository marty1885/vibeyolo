...
#include "Vlayer_32_tb.h"
#include "sim_ctrl.h"

using DUT = Vlayer_32_tb;

static constexpr int NCH_IN = 512;
static constexpr int NCH_OUT = 256;
...
static constexpr int N_COUT_TILE = 16;
static constexpr int N_CIN_TILE = 64;
static constexpr int N_LANE_TILE = 8;
static constexpr int N_LANE_FULL = 512;
...
int main(int argc, char** argv) {
    ...
    printf("Layer 32 RESIDUAL P_PIX=%d P_COUT=%d P_CIN=%d\n", P_PIX, P_COUT, P_CIN);
    printf("========================================\n");
    return sim.finish();
}
