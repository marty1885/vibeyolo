...
//
// Generated skeleton for L32 (RESIDUAL=1): /model.9/cv2/conv/Conv_quant

module layer_32
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_32_COUT,
  parameter int  CIN        = LAYER_32_CIN,
  parameter int  K          = LAYER_32_K,
  parameter int  STRIDE     = LAYER_32_STRIDE,
  parameter int  PAD        = LAYER_32_PAD,
  parameter int  P_COUT     = LAYER_32_P_COUT,
  parameter int  P_CIN      = LAYER_32_P_CIN,
  parameter int  P_PIX      = LAYER_32_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_32_H), .W_OUT(LAYER_32_W),
