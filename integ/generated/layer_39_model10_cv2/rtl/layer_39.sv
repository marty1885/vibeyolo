...
//
// Generated skeleton for L39: /model.10/cv2/conv/Conv_quant  (SILU=1)

module layer_39
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_39_COUT,
  parameter int  CIN        = LAYER_39_CIN,
  parameter int  K          = LAYER_39_K,
  parameter int  STRIDE     = LAYER_39_STRIDE,
  parameter int  PAD        = LAYER_39_PAD,
  parameter int  P_COUT     = LAYER_39_P_COUT,
  parameter int  P_CIN      = LAYER_39_P_CIN,
  parameter int  P_PIX      = LAYER_39_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_39_H), .W_OUT(LAYER_39_W),
