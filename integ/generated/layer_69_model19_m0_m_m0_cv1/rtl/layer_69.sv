...
//
// Generated skeleton for L69: /model.19/m.0/m/m.0/cv1/conv/Conv_quant  (SILU=0)

module layer_69
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_69_COUT,
  parameter int  CIN        = LAYER_69_CIN,
  parameter int  K          = LAYER_69_K,
  parameter int  STRIDE     = LAYER_69_STRIDE,
  parameter int  PAD        = LAYER_69_PAD,
  parameter int  P_COUT     = LAYER_69_P_COUT,
  parameter int  P_CIN      = LAYER_69_P_CIN,
  parameter int  P_PIX      = LAYER_69_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_69_H), .W_OUT(LAYER_69_W),
