...
#include <string>
#include <vector>
#include "Vlayer_58_tb.h"
#include "sim_ctrl.h"
using DUT = Vlayer_58_tb;
...
int main(int argc, char** argv) {
    ...
    printf("Layer 58 NOSILU P_PIX=%d P_COUT=%d P_CIN=%d\n", P_PIX, P_COUT, P_CIN);
    return sim.finish();
}
