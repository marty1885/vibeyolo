...
//
// Generated skeleton for L58: /model.17/conv/Conv_quant  (SILU=0)

module layer_58
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_58_COUT,
  parameter int  CIN        = LAYER_58_CIN,
  parameter int  K          = LAYER_58_K,
  parameter int  STRIDE     = LAYER_58_STRIDE,
  parameter int  PAD        = LAYER_58_PAD,
  parameter int  P_COUT     = LAYER_58_P_COUT,
  parameter int  P_CIN      = LAYER_58_P_CIN,
  parameter int  P_PIX      = LAYER_58_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_58_H), .W_OUT(LAYER_58_W),
