...
#include <string>
#include <vector>
#include "Vlayer_84_tb.h"
#include "sim_ctrl.h"
using DUT = Vlayer_84_tb;
...
static constexpr int N_LANE_TILE = 36;
static constexpr int N_LANE_FULL = 1152;
...
static constexpr int DOT_LAT = 7;
...
int main(int argc, char** argv) {
    ...
    printf("Layer 84 NOSILU P_PIX=%d P_COUT=%d P_CIN=%d\n", P_PIX, P_COUT, P_CIN);
    return sim.finish();
}
