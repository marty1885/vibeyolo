...
//
// Generated skeleton for L84: /model.22/m.0/m.0.0/cv1/conv/Conv_quant  (SILU=0)

module layer_84
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_84_COUT,
  parameter int  CIN        = LAYER_84_CIN,
  parameter int  K          = LAYER_84_K,
  parameter int  STRIDE     = LAYER_84_STRIDE,
  parameter int  PAD        = LAYER_84_PAD,
  parameter int  P_COUT     = LAYER_84_P_COUT,
  parameter int  P_CIN      = LAYER_84_P_CIN,
  parameter int  P_PIX      = LAYER_84_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_84_H), .W_OUT(LAYER_84_W),
