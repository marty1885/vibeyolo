...
//
// Generated skeleton for L81: /model.22/cv1/conv/Conv_quant  (SILU=1)

module layer_81
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_81_COUT,
  parameter int  CIN        = LAYER_81_CIN,
  parameter int  K          = LAYER_81_K,
  parameter int  STRIDE     = LAYER_81_STRIDE,
  parameter int  PAD        = LAYER_81_PAD,
  parameter int  P_COUT     = LAYER_81_P_COUT,
  parameter int  P_CIN      = LAYER_81_P_CIN,
  parameter int  P_PIX      = LAYER_81_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_81_H), .W_OUT(LAYER_81_W),
