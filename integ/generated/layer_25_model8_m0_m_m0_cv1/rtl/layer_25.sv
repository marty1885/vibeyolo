...
//
// Generated skeleton for L25: /model.8/m.0/m/m.0/cv1/conv/Conv_quant

module layer_25
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_25_COUT,
  parameter int  CIN        = LAYER_25_CIN,
  parameter int  K          = LAYER_25_K,
  parameter int  STRIDE     = LAYER_25_STRIDE,
  parameter int  PAD        = LAYER_25_PAD,
  parameter int  P_COUT     = LAYER_25_P_COUT,
  parameter int  P_CIN      = LAYER_25_P_CIN,
  parameter int  P_PIX      = LAYER_25_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_25_H), .W_OUT(LAYER_25_W),
