...
//
// Generated skeleton for L53 (RESIDUAL=1): /model.16/m.0/m/m.0/cv2/conv/Conv_quant

module layer_53
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_53_COUT,
  parameter int  CIN        = LAYER_53_CIN,
  parameter int  K          = LAYER_53_K,
  parameter int  STRIDE     = LAYER_53_STRIDE,
  parameter int  PAD        = LAYER_53_PAD,
  parameter int  P_COUT     = LAYER_53_P_COUT,
  parameter int  P_CIN      = LAYER_53_P_CIN,
  parameter int  P_PIX      = LAYER_53_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_53_H), .W_OUT(LAYER_53_W),
