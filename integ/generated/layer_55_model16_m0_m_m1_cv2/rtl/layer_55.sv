...
//
// Generated skeleton for L55 (RESIDUAL=1): /model.16/m.0/m/m.1/cv2/conv/Conv_quant

module layer_55
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_55_COUT,
  parameter int  CIN        = LAYER_55_CIN,
  parameter int  K          = LAYER_55_K,
  parameter int  STRIDE     = LAYER_55_STRIDE,
  parameter int  PAD        = LAYER_55_PAD,
  parameter int  P_COUT     = LAYER_55_P_COUT,
  parameter int  P_CIN      = LAYER_55_P_CIN,
  parameter int  P_PIX      = LAYER_55_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_55_H), .W_OUT(LAYER_55_W),
