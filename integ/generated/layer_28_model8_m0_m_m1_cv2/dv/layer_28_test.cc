...
#include "Vlayer_28_tb.h"
#include "sim_ctrl.h"

using DUT = Vlayer_28_tb;
...
static constexpr int N_COUT_TILE = 4;
static constexpr int N_CIN_TILE = 32;
static constexpr int N_LANE_TILE = 18;
static constexpr int N_LANE_FULL = 576;
...
int main(int argc, char** argv) {
    ...
    printf("Layer 28 RESIDUAL P_PIX=%d P_COUT=%d P_CIN=%d\n", P_PIX, P_COUT, P_CIN);
    printf("========================================\n");
    return sim.finish();
}
