...
//
// Generated skeleton for L28 (RESIDUAL=1): /model.8/m.0/m/m.1/cv2/conv/Conv_quant

module layer_28
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_28_COUT,
  parameter int  CIN        = LAYER_28_CIN,
  parameter int  K          = LAYER_28_K,
  parameter int  STRIDE     = LAYER_28_STRIDE,
  parameter int  PAD        = LAYER_28_PAD,
  parameter int  P_COUT     = LAYER_28_P_COUT,
  parameter int  P_CIN      = LAYER_28_P_CIN,
  parameter int  P_PIX      = LAYER_28_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_28_H), .W_OUT(LAYER_28_W),
