...
//
// Generated skeleton for L45: /model.13/m.0/m/m.1/cv1/conv/Conv_quant  (SILU=1)

module layer_45
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_45_COUT,
  parameter int  CIN        = LAYER_45_CIN,
  parameter int  K          = LAYER_45_K,
  parameter int  STRIDE     = LAYER_45_STRIDE,
  parameter int  PAD        = LAYER_45_PAD,
  parameter int  P_COUT     = LAYER_45_P_COUT,
  parameter int  P_CIN      = LAYER_45_P_CIN,
  parameter int  P_PIX      = LAYER_45_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_45_H), .W_OUT(LAYER_45_W),
