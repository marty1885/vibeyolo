...
//
// Generated skeleton for L56: /model.16/m.0/cv3/conv/Conv_quant  (SILU=1)

module layer_56
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_56_COUT,
  parameter int  CIN        = LAYER_56_CIN,
  parameter int  K          = LAYER_56_K,
  parameter int  STRIDE     = LAYER_56_STRIDE,
  parameter int  PAD        = LAYER_56_PAD,
  parameter int  P_COUT     = LAYER_56_P_COUT,
  parameter int  P_CIN      = LAYER_56_P_CIN,
  parameter int  P_PIX      = LAYER_56_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_56_H), .W_OUT(LAYER_56_W),
