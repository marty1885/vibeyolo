...
//
// Generated skeleton for L88: /model.22/m.0/m.0.1/attn/qkv/conv/Conv_quant  (SILU=0)

module layer_88
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_88_COUT,
  parameter int  CIN        = LAYER_88_CIN,
  parameter int  K          = LAYER_88_K,
  parameter int  STRIDE     = LAYER_88_STRIDE,
  parameter int  PAD        = LAYER_88_PAD,
  parameter int  P_COUT     = LAYER_88_P_COUT,
  parameter int  P_CIN      = LAYER_88_P_CIN,
  parameter int  P_PIX      = LAYER_88_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_88_H), .W_OUT(LAYER_88_W),
