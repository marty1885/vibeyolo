...
//
// Generated skeleton for L36 (RESIDUAL=1): /model.10/m/m.0/attn/proj/conv/Conv_quant

module layer_36
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_36_COUT,
  parameter int  CIN        = LAYER_36_CIN,
  parameter int  K          = LAYER_36_K,
  parameter int  STRIDE     = LAYER_36_STRIDE,
  parameter int  PAD        = LAYER_36_PAD,
  parameter int  P_COUT     = LAYER_36_P_COUT,
  parameter int  P_CIN      = LAYER_36_P_CIN,
  parameter int  P_PIX      = LAYER_36_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_36_H), .W_OUT(LAYER_36_W),
