...
//
// Generated skeleton for L46 (RESIDUAL=1): /model.13/m.0/m/m.1/cv2/conv/Conv_quant

module layer_46
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_46_COUT,
  parameter int  CIN        = LAYER_46_CIN,
  parameter int  K          = LAYER_46_K,
  parameter int  STRIDE     = LAYER_46_STRIDE,
  parameter int  PAD        = LAYER_46_PAD,
  parameter int  P_COUT     = LAYER_46_P_COUT,
  parameter int  P_CIN      = LAYER_46_P_CIN,
  parameter int  P_PIX      = LAYER_46_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_46_H), .W_OUT(LAYER_46_W),
