...
//
// Generated skeleton for L49: /model.16/cv1/conv/Conv_quant  (SILU=1)

module layer_49
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_49_COUT,
  parameter int  CIN        = LAYER_49_CIN,
  parameter int  K          = LAYER_49_K,
  parameter int  STRIDE     = LAYER_49_STRIDE,
  parameter int  PAD        = LAYER_49_PAD,
  parameter int  P_COUT     = LAYER_49_P_COUT,
  parameter int  P_CIN      = LAYER_49_P_CIN,
  parameter int  P_PIX      = LAYER_49_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_49_H), .W_OUT(LAYER_49_W),
