...
//
// Generated skeleton for L47: /model.13/m.0/cv3/conv/Conv_quant  (SILU=1)

module layer_47
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_47_COUT,
  parameter int  CIN        = LAYER_47_CIN,
  parameter int  K          = LAYER_47_K,
  parameter int  STRIDE     = LAYER_47_STRIDE,
  parameter int  PAD        = LAYER_47_PAD,
  parameter int  P_COUT     = LAYER_47_P_COUT,
  parameter int  P_CIN      = LAYER_47_P_CIN,
  parameter int  P_PIX      = LAYER_47_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_47_H), .W_OUT(LAYER_47_W),
