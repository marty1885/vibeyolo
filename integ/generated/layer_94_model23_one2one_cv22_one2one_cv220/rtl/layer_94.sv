...
//
// Generated skeleton for L94: /model.23/one2one_cv2.2/one2one_cv2.2.0/conv/Conv_quant  (SILU=1)

module layer_94
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_94_COUT,
  parameter int  CIN        = LAYER_94_CIN,
  parameter int  K          = LAYER_94_K,
  parameter int  STRIDE     = LAYER_94_STRIDE,
  parameter int  PAD        = LAYER_94_PAD,
  parameter int  P_COUT     = LAYER_94_P_COUT,
  parameter int  P_CIN      = LAYER_94_P_CIN,
  parameter int  P_PIX      = LAYER_94_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_94_H), .W_OUT(LAYER_94_W),
