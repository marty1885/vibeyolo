...
#include "Vlayer_38_tb.h"
#include "sim_ctrl.h"

using DUT = Vlayer_38_tb;

static constexpr int NCH_IN = 256;
...
static constexpr int N_COUT_TILE = 8;
static constexpr int N_CIN_TILE = 32;
static constexpr int N_LANE_TILE = 8;
static constexpr int N_LANE_FULL = 256;
...
static constexpr int SILU_LAT = 0;
...
int main(int argc, char** argv) {
    ...
    printf("Layer 38 RESIDUAL P_PIX=%d P_COUT=%d P_CIN=%d\n", P_PIX, P_COUT, P_CIN);
    printf("========================================\n");
    return sim.finish();
}
