...
//
// Generated skeleton for L38 (RESIDUAL=1): /model.10/m/m.0/ffn/ffn.1/conv/Conv_quant

module layer_38
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_38_COUT,
  parameter int  CIN        = LAYER_38_CIN,
  parameter int  K          = LAYER_38_K,
  parameter int  STRIDE     = LAYER_38_STRIDE,
  parameter int  PAD        = LAYER_38_PAD,
  parameter int  P_COUT     = LAYER_38_P_COUT,
  parameter int  P_CIN      = LAYER_38_P_CIN,
  parameter int  P_PIX      = LAYER_38_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_38_H), .W_OUT(LAYER_38_W),
