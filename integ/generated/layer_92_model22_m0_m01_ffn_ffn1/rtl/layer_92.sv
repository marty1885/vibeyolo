...
//
// Generated skeleton for L92 (RESIDUAL=1): /model.22/m.0/m.0.1/ffn/ffn.1/conv/Conv_quant

module layer_92
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_92_COUT,
  parameter int  CIN        = LAYER_92_CIN,
  parameter int  K          = LAYER_92_K,
  parameter int  STRIDE     = LAYER_92_STRIDE,
  parameter int  PAD        = LAYER_92_PAD,
  parameter int  P_COUT     = LAYER_92_P_COUT,
  parameter int  P_CIN      = LAYER_92_P_CIN,
  parameter int  P_PIX      = LAYER_92_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_92_H), .W_OUT(LAYER_92_W),
