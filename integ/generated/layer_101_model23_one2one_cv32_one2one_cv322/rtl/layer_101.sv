...
//
// Generated skeleton for L101: /model.23/one2one_cv3.2/one2one_cv3.2.2/Conv_quant  (SILU=0)

module layer_101
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_101_COUT,
  parameter int  CIN        = LAYER_101_CIN,
  parameter int  K          = LAYER_101_K,
  parameter int  STRIDE     = LAYER_101_STRIDE,
  parameter int  PAD        = LAYER_101_PAD,
  parameter int  P_COUT     = LAYER_101_P_COUT,
  parameter int  P_CIN      = LAYER_101_P_CIN,
  parameter int  P_PIX      = LAYER_101_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_101_H), .W_OUT(LAYER_101_W),
