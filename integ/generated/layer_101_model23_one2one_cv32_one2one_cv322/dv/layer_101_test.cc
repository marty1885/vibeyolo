...
#include <string>
#include <vector>
#include "Vlayer_101_tb.h"
#include "sim_ctrl.h"
using DUT = Vlayer_101_tb;
...
static constexpr int N_CIN_TILE = 40;
static constexpr int N_LANE_TILE = 2;
...
static constexpr int DOT_LAT = 2;
...
int main(int argc, char** argv) {
    ...
    printf("Layer 101 NOSILU P_PIX=%d P_COUT=%d P_CIN=%d\n", P_PIX, P_COUT, P_CIN);
    return sim.finish();
}
