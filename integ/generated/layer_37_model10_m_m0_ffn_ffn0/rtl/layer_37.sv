...
//
// Generated skeleton for L37: /model.10/m/m.0/ffn/ffn.0/conv/Conv_quant  (SILU=1)

module layer_37
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_37_COUT,
  parameter int  CIN        = LAYER_37_CIN,
  parameter int  K          = LAYER_37_K,
  parameter int  STRIDE     = LAYER_37_STRIDE,
  parameter int  PAD        = LAYER_37_PAD,
  parameter int  P_COUT     = LAYER_37_P_COUT,
  parameter int  P_CIN      = LAYER_37_P_CIN,
  parameter int  P_PIX      = LAYER_37_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_37_H), .W_OUT(LAYER_37_W),
