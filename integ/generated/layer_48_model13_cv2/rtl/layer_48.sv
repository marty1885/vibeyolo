...
//
// Generated skeleton for L48: /model.13/cv2/conv/Conv_quant  (SILU=1)

module layer_48
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_48_COUT,
  parameter int  CIN        = LAYER_48_CIN,
  parameter int  K          = LAYER_48_K,
  parameter int  STRIDE     = LAYER_48_STRIDE,
  parameter int  PAD        = LAYER_48_PAD,
  parameter int  P_COUT     = LAYER_48_P_COUT,
  parameter int  P_CIN      = LAYER_48_P_CIN,
  parameter int  P_PIX      = LAYER_48_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_48_H), .W_OUT(LAYER_48_W),
