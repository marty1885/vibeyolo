...
//
// Generated skeleton for L23: /model.8/m.0/cv1/conv/Conv_quant

module layer_23
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_23_COUT,
  parameter int  CIN        = LAYER_23_CIN,
  parameter int  K          = LAYER_23_K,
  parameter int  STRIDE     = LAYER_23_STRIDE,
  parameter int  PAD        = LAYER_23_PAD,
  parameter int  P_COUT     = LAYER_23_P_COUT,
  parameter int  P_CIN      = LAYER_23_P_CIN,
  parameter int  P_PIX      = LAYER_23_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_23_H), .W_OUT(LAYER_23_W),
