...
//
// Generated skeleton for L34: /model.10/m/m.0/attn/qkv/conv/Conv_quant  (SILU=0)

module layer_34
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_34_COUT,
  parameter int  CIN        = LAYER_34_CIN,
  parameter int  K          = LAYER_34_K,
  parameter int  STRIDE     = LAYER_34_STRIDE,
  parameter int  PAD        = LAYER_34_PAD,
  parameter int  P_COUT     = LAYER_34_P_COUT,
  parameter int  P_CIN      = LAYER_34_P_CIN,
  parameter int  P_PIX      = LAYER_34_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_34_H), .W_OUT(LAYER_34_W),
