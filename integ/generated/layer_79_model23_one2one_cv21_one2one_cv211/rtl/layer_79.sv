...
//
// Generated skeleton for L79: /model.23/one2one_cv2.1/one2one_cv2.1.1/conv/Conv_quant  (SILU=0)

module layer_79
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_79_COUT,
  parameter int  CIN        = LAYER_79_CIN,
  parameter int  K          = LAYER_79_K,
  parameter int  STRIDE     = LAYER_79_STRIDE,
  parameter int  PAD        = LAYER_79_PAD,
  parameter int  P_COUT     = LAYER_79_P_COUT,
  parameter int  P_CIN      = LAYER_79_P_CIN,
  parameter int  P_PIX      = LAYER_79_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_79_H), .W_OUT(LAYER_79_W),
