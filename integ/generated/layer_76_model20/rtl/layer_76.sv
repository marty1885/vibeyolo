...
//
// Generated skeleton for L76: /model.20/conv/Conv_quant  (SILU=0)

module layer_76
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_76_COUT,
  parameter int  CIN        = LAYER_76_CIN,
  parameter int  K          = LAYER_76_K,
  parameter int  STRIDE     = LAYER_76_STRIDE,
  parameter int  PAD        = LAYER_76_PAD,
  parameter int  P_COUT     = LAYER_76_P_COUT,
  parameter int  P_CIN      = LAYER_76_P_CIN,
  parameter int  P_PIX      = LAYER_76_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_76_H), .W_OUT(LAYER_76_W),
