...
//
// Generated skeleton for L74: /model.19/m.0/cv3/conv/Conv_quant  (SILU=1)

module layer_74
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_74_COUT,
  parameter int  CIN        = LAYER_74_CIN,
  parameter int  K          = LAYER_74_K,
  parameter int  STRIDE     = LAYER_74_STRIDE,
  parameter int  PAD        = LAYER_74_PAD,
  parameter int  P_COUT     = LAYER_74_P_COUT,
  parameter int  P_CIN      = LAYER_74_P_CIN,
  parameter int  P_PIX      = LAYER_74_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_74_H), .W_OUT(LAYER_74_W),
