...
//
// Generated skeleton for L41: /model.13/m.0/cv1/conv/Conv_quant  (SILU=1)

module layer_41
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_41_COUT,
  parameter int  CIN        = LAYER_41_CIN,
  parameter int  K          = LAYER_41_K,
  parameter int  STRIDE     = LAYER_41_STRIDE,
  parameter int  PAD        = LAYER_41_PAD,
  parameter int  P_COUT     = LAYER_41_P_COUT,
  parameter int  P_CIN      = LAYER_41_P_CIN,
  parameter int  P_PIX      = LAYER_41_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_41_H), .W_OUT(LAYER_41_W),
