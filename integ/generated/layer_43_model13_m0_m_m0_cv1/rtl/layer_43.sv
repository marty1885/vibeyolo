...
//
// Generated skeleton for L43: /model.13/m.0/m/m.0/cv1/conv/Conv_quant  (SILU=1)

module layer_43
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_43_COUT,
  parameter int  CIN        = LAYER_43_CIN,
  parameter int  K          = LAYER_43_K,
  parameter int  STRIDE     = LAYER_43_STRIDE,
  parameter int  PAD        = LAYER_43_PAD,
  parameter int  P_COUT     = LAYER_43_P_COUT,
  parameter int  P_CIN      = LAYER_43_P_CIN,
  parameter int  P_PIX      = LAYER_43_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_43_H), .W_OUT(LAYER_43_W),
