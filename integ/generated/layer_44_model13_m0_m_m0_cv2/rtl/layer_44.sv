...
//
// Generated skeleton for L44 (RESIDUAL=1): /model.13/m.0/m/m.0/cv2/conv/Conv_quant

module layer_44
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_44_COUT,
  parameter int  CIN        = LAYER_44_CIN,
  parameter int  K          = LAYER_44_K,
  parameter int  STRIDE     = LAYER_44_STRIDE,
  parameter int  PAD        = LAYER_44_PAD,
  parameter int  P_COUT     = LAYER_44_P_COUT,
  parameter int  P_CIN      = LAYER_44_P_CIN,
  parameter int  P_PIX      = LAYER_44_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_44_H), .W_OUT(LAYER_44_W),
