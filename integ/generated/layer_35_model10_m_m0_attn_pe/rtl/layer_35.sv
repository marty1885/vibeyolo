...
//
// Generated skeleton for L35: /model.10/m/m.0/attn/pe/conv/Conv_quant  (SILU=0)

module layer_35
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_35_COUT,
  parameter int  CIN        = LAYER_35_CIN,
  parameter int  K          = LAYER_35_K,
  parameter int  STRIDE     = LAYER_35_STRIDE,
  parameter int  PAD        = LAYER_35_PAD,
  parameter int  P_COUT     = LAYER_35_P_COUT,
  parameter int  P_CIN      = LAYER_35_P_CIN,
  parameter int  P_PIX      = LAYER_35_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_35_H), .W_OUT(LAYER_35_W),
