...
//
// Generated skeleton for L50: /model.16/m.0/cv1/conv/Conv_quant  (SILU=1)

module layer_50
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_50_COUT,
  parameter int  CIN        = LAYER_50_CIN,
  parameter int  K          = LAYER_50_K,
  parameter int  STRIDE     = LAYER_50_STRIDE,
  parameter int  PAD        = LAYER_50_PAD,
  parameter int  P_COUT     = LAYER_50_P_COUT,
  parameter int  P_CIN      = LAYER_50_P_CIN,
  parameter int  P_PIX      = LAYER_50_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_50_H), .W_OUT(LAYER_50_W),
