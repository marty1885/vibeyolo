...
//
// Generated skeleton for L87: /model.23/one2one_cv3.1/one2one_cv3.1.2/Conv_quant  (SILU=0)

module layer_87
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_87_COUT,
  parameter int  CIN        = LAYER_87_CIN,
  parameter int  K          = LAYER_87_K,
  parameter int  STRIDE     = LAYER_87_STRIDE,
  parameter int  PAD        = LAYER_87_PAD,
  parameter int  P_COUT     = LAYER_87_P_COUT,
  parameter int  P_CIN      = LAYER_87_P_CIN,
  parameter int  P_PIX      = LAYER_87_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_87_H), .W_OUT(LAYER_87_W),
