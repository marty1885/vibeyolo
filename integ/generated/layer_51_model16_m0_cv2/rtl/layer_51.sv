...
//
// Generated skeleton for L51: /model.16/m.0/cv2/conv/Conv_quant  (SILU=1)

module layer_51
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_51_COUT,
  parameter int  CIN        = LAYER_51_CIN,
  parameter int  K          = LAYER_51_K,
  parameter int  STRIDE     = LAYER_51_STRIDE,
  parameter int  PAD        = LAYER_51_PAD,
  parameter int  P_COUT     = LAYER_51_P_COUT,
  parameter int  P_CIN      = LAYER_51_P_CIN,
  parameter int  P_PIX      = LAYER_51_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_51_H), .W_OUT(LAYER_51_W),
