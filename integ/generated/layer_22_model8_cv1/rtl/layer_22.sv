...
//
// Generated skeleton for L22: /model.8/cv1/conv/Conv_quant  (SILU=1)

module layer_22
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_22_COUT,
  parameter int  CIN        = LAYER_22_CIN,
  parameter int  K          = LAYER_22_K,
  parameter int  STRIDE     = LAYER_22_STRIDE,
  parameter int  PAD        = LAYER_22_PAD,
  parameter int  P_COUT     = LAYER_22_P_COUT,
  parameter int  P_CIN      = LAYER_22_P_CIN,
  parameter int  P_PIX      = LAYER_22_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_22_H), .W_OUT(LAYER_22_W),
