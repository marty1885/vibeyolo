...
//
// Generated skeleton for L70: /model.23/one2one_cv3.0/one2one_cv3.0.2/Conv_quant  (SILU=0)

module layer_70
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_70_COUT,
  parameter int  CIN        = LAYER_70_CIN,
  parameter int  K          = LAYER_70_K,
  parameter int  STRIDE     = LAYER_70_STRIDE,
  parameter int  PAD        = LAYER_70_PAD,
  parameter int  P_COUT     = LAYER_70_P_COUT,
  parameter int  P_CIN      = LAYER_70_P_CIN,
  parameter int  P_PIX      = LAYER_70_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_70_H), .W_OUT(LAYER_70_W),
