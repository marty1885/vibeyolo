...
#include <string>
#include <vector>
#include "Vlayer_70_tb.h"
#include "sim_ctrl.h"
using DUT = Vlayer_70_tb;

static constexpr int NCH_IN = 80;
...
static constexpr int N_CIN_TILE = 10;
static constexpr int N_LANE_TILE = 8;
static constexpr int N_LANE_FULL = 80;
...
int main(int argc, char** argv) {
    ...
    printf("Layer 70 NOSILU P_PIX=%d P_COUT=%d P_CIN=%d\n", P_PIX, P_COUT, P_CIN);
    return sim.finish();
}
