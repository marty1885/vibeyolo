# layer_99_model23_one2one_cv32_one2one_cv321_one2one_cv3210

Generated ordinary Conv+SiLU integration layer for `/model.23/one2one_cv3.2/one2one_cv3.2.1/one2one_cv3.2.1.0/conv/Conv_quant`.

- Shape: Cin=80 Cout=80 K=3 stride=1 pad=1
- Output: 20x20
- Generated DV wrapper factors: P_PIX=1, P_COUT=1, P_CIN=1, cycles~32000
