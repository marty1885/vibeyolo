...
#include "Vlayer_95_tb.h"
#include "sim_ctrl.h"

using DUT = Vlayer_95_tb;
...
static constexpr int N_COUT_TILE = 128;
static constexpr int N_CIN_TILE = 256;
static constexpr int N_LANE_TILE = 9;
static constexpr int N_LANE_FULL = 2304;
...
int main(int argc, char** argv) {
    ...
    printf("  worst max = %.6f\n", agg_max);
    printf("Layer 95 P_PIX=%d P_COUT=%d P_CIN=%d K=%d stride=%d pad=%d\n", P_PIX, P_COUT, P_CIN, K, STRIDE, PAD);
    printf("========================================\n");
    return sim.finish();
}
