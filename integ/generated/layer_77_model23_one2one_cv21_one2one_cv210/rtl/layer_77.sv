...
//
// Generated skeleton for L77: /model.23/one2one_cv2.1/one2one_cv2.1.0/conv/Conv_quant  (SILU=0)

module layer_77
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_77_COUT,
  parameter int  CIN        = LAYER_77_CIN,
  parameter int  K          = LAYER_77_K,
  parameter int  STRIDE     = LAYER_77_STRIDE,
  parameter int  PAD        = LAYER_77_PAD,
  parameter int  P_COUT     = LAYER_77_P_COUT,
  parameter int  P_CIN      = LAYER_77_P_CIN,
  parameter int  P_PIX      = LAYER_77_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_77_H), .W_OUT(LAYER_77_W),
