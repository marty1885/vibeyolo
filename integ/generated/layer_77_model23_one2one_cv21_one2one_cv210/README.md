# layer_77_model23_one2one_cv21_one2one_cv210

Generated ordinary Conv+SiLU integration layer for `/model.23/one2one_cv2.1/one2one_cv2.1.0/conv/Conv_quant`.

- Shape: Cin=128 Cout=16 K=3 stride=1 pad=1
- Output: 40x40
