...
//
// Generated skeleton for L82: /model.23/one2one_cv2.1/one2one_cv2.1.2/Conv_quant  (SILU=0)

module layer_82
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_82_COUT,
  parameter int  CIN        = LAYER_82_CIN,
  parameter int  K          = LAYER_82_K,
  parameter int  STRIDE     = LAYER_82_STRIDE,
  parameter int  PAD        = LAYER_82_PAD,
  parameter int  P_COUT     = LAYER_82_P_COUT,
  parameter int  P_CIN      = LAYER_82_P_CIN,
  parameter int  P_PIX      = LAYER_82_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_82_H), .W_OUT(LAYER_82_W),
