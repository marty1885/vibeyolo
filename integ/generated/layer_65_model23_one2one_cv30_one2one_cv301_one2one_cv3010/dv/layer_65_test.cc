...
#include "Vlayer_65_tb.h"
#include "sim_ctrl.h"

using DUT = Vlayer_65_tb;
...
static constexpr int P_COUT = 8;
static constexpr int P_CIN = 1;
static constexpr int N_COUT_TILE = 10;
...
int main(int argc, char** argv) {
    ...
    printf("  worst max = %.6f\n", agg_max);
    printf("Layer 65 P_PIX=%d P_COUT=%d P_CIN=%d K=%d stride=%d pad=%d\n", P_PIX, P_COUT, P_CIN, K, STRIDE, PAD);
    printf("========================================\n");
    return sim.finish();
}
