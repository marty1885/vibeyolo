...
//
// Generated skeleton for L63: /model.19/cv1/conv/Conv_quant  (SILU=1)

module layer_63
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_63_COUT,
  parameter int  CIN        = LAYER_63_CIN,
  parameter int  K          = LAYER_63_K,
  parameter int  STRIDE     = LAYER_63_STRIDE,
  parameter int  PAD        = LAYER_63_PAD,
  parameter int  P_COUT     = LAYER_63_P_COUT,
  parameter int  P_CIN      = LAYER_63_P_CIN,
  parameter int  P_PIX      = LAYER_63_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_63_H), .W_OUT(LAYER_63_W),
