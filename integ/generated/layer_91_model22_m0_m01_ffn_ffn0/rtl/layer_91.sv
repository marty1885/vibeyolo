...
//
// Generated skeleton for L91: /model.22/m.0/m.0.1/ffn/ffn.0/conv/Conv_quant  (SILU=1)

module layer_91
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_91_COUT,
  parameter int  CIN        = LAYER_91_CIN,
  parameter int  K          = LAYER_91_K,
  parameter int  STRIDE     = LAYER_91_STRIDE,
  parameter int  PAD        = LAYER_91_PAD,
  parameter int  P_COUT     = LAYER_91_P_COUT,
  parameter int  P_CIN      = LAYER_91_P_CIN,
  parameter int  P_PIX      = LAYER_91_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_91_H), .W_OUT(LAYER_91_W),
