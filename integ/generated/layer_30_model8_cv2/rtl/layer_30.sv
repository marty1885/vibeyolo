...
//
// Generated skeleton for L30: /model.8/cv2/conv/Conv_quant  (SILU=1)

module layer_30
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_30_COUT,
  parameter int  CIN        = LAYER_30_CIN,
  parameter int  K          = LAYER_30_K,
  parameter int  STRIDE     = LAYER_30_STRIDE,
  parameter int  PAD        = LAYER_30_PAD,
  parameter int  P_COUT     = LAYER_30_P_COUT,
  parameter int  P_CIN      = LAYER_30_P_CIN,
  parameter int  P_PIX      = LAYER_30_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_30_H), .W_OUT(LAYER_30_W),
