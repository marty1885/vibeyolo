...
#include "Vlayer_30_tb.h"
#include "sim_ctrl.h"

using DUT = Vlayer_30_tb;

static constexpr int NCH_IN = 384;
...
static constexpr int N_CIN_TILE = 48;
static constexpr int N_LANE_TILE = 8;
static constexpr int N_LANE_FULL = 384;
...
int main(int argc, char** argv) {
    ...
    printf("  worst max = %.6f\n", agg_max);
    printf("Layer 30 P_PIX=%d P_COUT=%d P_CIN=%d K=%d stride=%d pad=%d\n", P_PIX, P_COUT, P_CIN, K, STRIDE, PAD);
    printf("========================================\n");
    return sim.finish();
}
