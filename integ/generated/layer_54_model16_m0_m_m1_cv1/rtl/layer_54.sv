...
//
// Generated skeleton for L54: /model.16/m.0/m/m.1/cv1/conv/Conv_quant  (SILU=1)

module layer_54
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_54_COUT,
  parameter int  CIN        = LAYER_54_CIN,
  parameter int  K          = LAYER_54_K,
  parameter int  STRIDE     = LAYER_54_STRIDE,
  parameter int  PAD        = LAYER_54_PAD,
  parameter int  P_COUT     = LAYER_54_P_COUT,
  parameter int  P_CIN      = LAYER_54_P_CIN,
  parameter int  P_PIX      = LAYER_54_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_54_H), .W_OUT(LAYER_54_W),
