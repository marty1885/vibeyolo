...
//
// Generated skeleton for L0: /model.0/conv/Conv_quant  (SILU=1)

module layer_0
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_0_COUT,
  parameter int  CIN        = LAYER_0_CIN,
  parameter int  K          = LAYER_0_K,
  parameter int  STRIDE     = LAYER_0_STRIDE,
  parameter int  PAD        = LAYER_0_PAD,
  parameter int  P_COUT     = LAYER_0_P_COUT,
  parameter int  P_CIN      = LAYER_0_P_CIN,
  parameter int  P_PIX      = LAYER_0_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_0_H), .W_OUT(LAYER_0_W),
