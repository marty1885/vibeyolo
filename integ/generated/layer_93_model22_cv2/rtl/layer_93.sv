...
//
// Generated skeleton for L93: /model.22/cv2/conv/Conv_quant  (SILU=1)

module layer_93
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_93_COUT,
  parameter int  CIN        = LAYER_93_CIN,
  parameter int  K          = LAYER_93_K,
  parameter int  STRIDE     = LAYER_93_STRIDE,
  parameter int  PAD        = LAYER_93_PAD,
  parameter int  P_COUT     = LAYER_93_P_COUT,
  parameter int  P_CIN      = LAYER_93_P_CIN,
  parameter int  P_PIX      = LAYER_93_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_93_H), .W_OUT(LAYER_93_W),
