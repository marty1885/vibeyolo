...
//
// Generated skeleton for L72: /model.19/m.0/m/m.1/cv1/conv/Conv_quant  (SILU=1)

module layer_72
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_72_COUT,
  parameter int  CIN        = LAYER_72_CIN,
  parameter int  K          = LAYER_72_K,
  parameter int  STRIDE     = LAYER_72_STRIDE,
  parameter int  PAD        = LAYER_72_PAD,
  parameter int  P_COUT     = LAYER_72_P_COUT,
  parameter int  P_CIN      = LAYER_72_P_CIN,
  parameter int  P_PIX      = LAYER_72_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_72_H), .W_OUT(LAYER_72_W),
