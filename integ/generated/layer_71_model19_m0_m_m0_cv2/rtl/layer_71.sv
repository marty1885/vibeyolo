...
//
// Generated skeleton for L71 (RESIDUAL=1): /model.19/m.0/m/m.0/cv2/conv/Conv_quant

module layer_71
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_71_COUT,
  parameter int  CIN        = LAYER_71_CIN,
  parameter int  K          = LAYER_71_K,
  parameter int  STRIDE     = LAYER_71_STRIDE,
  parameter int  PAD        = LAYER_71_PAD,
  parameter int  P_COUT     = LAYER_71_P_COUT,
  parameter int  P_CIN      = LAYER_71_P_CIN,
  parameter int  P_PIX      = LAYER_71_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_71_H), .W_OUT(LAYER_71_W),
