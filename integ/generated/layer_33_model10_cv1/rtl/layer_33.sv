...
//
// Generated skeleton for L33: /model.10/cv1/conv/Conv_quant  (SILU=1)

module layer_33
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_33_COUT,
  parameter int  CIN        = LAYER_33_CIN,
  parameter int  K          = LAYER_33_K,
  parameter int  STRIDE     = LAYER_33_STRIDE,
  parameter int  PAD        = LAYER_33_PAD,
  parameter int  P_COUT     = LAYER_33_P_COUT,
  parameter int  P_CIN      = LAYER_33_P_CIN,
  parameter int  P_PIX      = LAYER_33_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_33_H), .W_OUT(LAYER_33_W),
