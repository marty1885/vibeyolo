...
//
// Generated skeleton for L21: /model.7/conv/Conv_quant  (SILU=1)

module layer_21
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_21_COUT,
  parameter int  CIN        = LAYER_21_CIN,
  parameter int  K          = LAYER_21_K,
  parameter int  STRIDE     = LAYER_21_STRIDE,
  parameter int  PAD        = LAYER_21_PAD,
  parameter int  P_COUT     = LAYER_21_P_COUT,
  parameter int  P_CIN      = LAYER_21_P_CIN,
  parameter int  P_PIX      = LAYER_21_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_21_H), .W_OUT(LAYER_21_W),
