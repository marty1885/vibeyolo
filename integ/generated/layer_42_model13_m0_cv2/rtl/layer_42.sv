...
//
// Generated skeleton for L42: /model.13/m.0/cv2/conv/Conv_quant  (SILU=1)

module layer_42
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_42_COUT,
  parameter int  CIN        = LAYER_42_CIN,
  parameter int  K          = LAYER_42_K,
  parameter int  STRIDE     = LAYER_42_STRIDE,
  parameter int  PAD        = LAYER_42_PAD,
  parameter int  P_COUT     = LAYER_42_P_COUT,
  parameter int  P_CIN      = LAYER_42_P_CIN,
  parameter int  P_PIX      = LAYER_42_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_42_H), .W_OUT(LAYER_42_W),
