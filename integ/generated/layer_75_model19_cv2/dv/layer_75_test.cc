...
#include "Vlayer_75_tb.h"
#include "sim_ctrl.h"

using DUT = Vlayer_75_tb;
...
static constexpr int N_CIN_TILE = 24;
static constexpr int N_LANE_TILE = 8;
static constexpr int N_LANE_FULL = 192;
...
int main(int argc, char** argv) {
    ...
    printf("  worst max = %.6f\n", agg_max);
    printf("Layer 75 P_PIX=%d P_COUT=%d P_CIN=%d K=%d stride=%d pad=%d\n", P_PIX, P_COUT, P_CIN, K, STRIDE, PAD);
    printf("========================================\n");
    return sim.finish();
}
