...
//
// Generated skeleton for L75: /model.19/cv2/conv/Conv_quant  (SILU=1)

module layer_75
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_75_COUT,
  parameter int  CIN        = LAYER_75_CIN,
  parameter int  K          = LAYER_75_K,
  parameter int  STRIDE     = LAYER_75_STRIDE,
  parameter int  PAD        = LAYER_75_PAD,
  parameter int  P_COUT     = LAYER_75_P_COUT,
  parameter int  P_CIN      = LAYER_75_P_CIN,
  parameter int  P_PIX      = LAYER_75_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_75_H), .W_OUT(LAYER_75_W),
