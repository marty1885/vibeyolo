...
//
// Generated skeleton for L61: /model.23/one2one_cv2.0/one2one_cv2.0.1/conv/Conv_quant  (SILU=0)

module layer_61
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_61_COUT,
  parameter int  CIN        = LAYER_61_CIN,
  parameter int  K          = LAYER_61_K,
  parameter int  STRIDE     = LAYER_61_STRIDE,
  parameter int  PAD        = LAYER_61_PAD,
  parameter int  P_COUT     = LAYER_61_P_COUT,
  parameter int  P_CIN      = LAYER_61_P_CIN,
  parameter int  P_PIX      = LAYER_61_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_61_H), .W_OUT(LAYER_61_W),
