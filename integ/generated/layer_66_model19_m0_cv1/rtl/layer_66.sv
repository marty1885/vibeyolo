...
//
// Generated skeleton for L66: /model.19/m.0/cv1/conv/Conv_quant  (SILU=0)

module layer_66
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_66_COUT,
  parameter int  CIN        = LAYER_66_CIN,
  parameter int  K          = LAYER_66_K,
  parameter int  STRIDE     = LAYER_66_STRIDE,
  parameter int  PAD        = LAYER_66_PAD,
  parameter int  P_COUT     = LAYER_66_P_COUT,
  parameter int  P_CIN      = LAYER_66_P_CIN,
  parameter int  P_PIX      = LAYER_66_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_66_H), .W_OUT(LAYER_66_W),
