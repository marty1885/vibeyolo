...
//
// Generated skeleton for L98: /model.23/one2one_cv2.2/one2one_cv2.2.2/Conv_quant  (SILU=0)

module layer_98
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_98_COUT,
  parameter int  CIN        = LAYER_98_CIN,
  parameter int  K          = LAYER_98_K,
  parameter int  STRIDE     = LAYER_98_STRIDE,
  parameter int  PAD        = LAYER_98_PAD,
  parameter int  P_COUT     = LAYER_98_P_COUT,
  parameter int  P_CIN      = LAYER_98_P_CIN,
  parameter int  P_PIX      = LAYER_98_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_98_H), .W_OUT(LAYER_98_W),
