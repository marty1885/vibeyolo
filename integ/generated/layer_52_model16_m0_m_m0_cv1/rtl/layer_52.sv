...
//
// Generated skeleton for L52: /model.16/m.0/m/m.0/cv1/conv/Conv_quant  (SILU=1)

module layer_52
  import scale_pkg::*;
#(
  parameter int  COUT       = LAYER_52_COUT,
  parameter int  CIN        = LAYER_52_CIN,
  parameter int  K          = LAYER_52_K,
  parameter int  STRIDE     = LAYER_52_STRIDE,
  parameter int  PAD        = LAYER_52_PAD,
  parameter int  P_COUT     = LAYER_52_P_COUT,
  parameter int  P_CIN      = LAYER_52_P_CIN,
  parameter int  P_PIX      = LAYER_52_P_PIX,
  ...
  for (genvar pix = 0; pix < P_PIX; pix++) begin : gen_pix
    ...
    conv_layer #(
      ...
      .H_OUT(LAYER_52_H), .W_OUT(LAYER_52_W),
