...
//
// The DUT pipeline has 5 cycles of latency; we apply stimulus, then
// sample (y, valid) 5 cycles later.
...
int main(int argc, char** argv) {
    ...
    auto run = [&](const std::vector<Stim>& seq, const char* tag,
        ...
        for (int i = 0; i < total; i++) {
            ...
            // Output now corresponds to whatever was applied 5 cycles ago.
            // Track via FIFO.
